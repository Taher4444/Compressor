...
#
#  License can be found in < https://github.com/im-vivektomar/Compressor/blob/public/LICENSE> .
...
async def source(event):
    await event.edit(source_text,
                    buttons=[[
                         Button.url("FOR PERSONAL USE", url="https://github.com/im-vivektomar/Compressor/tree/main"),
                         Button.url("FOR YOUR CHANNEL ", url="https://github.com/im-vivektomar/Compressor")]])
